<template>
  <div class="container">
    <form>
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          ...
          <div class="form-group">
            ...
            <!-- update password after focus out -->
            <input
              type="password"
              id="password"
              class="form-control"
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
          ...
          <select id="priority" class="form-control" v-model="selectedPriority">
            <option :selected="p == selectedPriority" v-for="p in priorities" :key="p">{{p}}</option>
          </select>
        </div>
      </div>
      <hr />
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          <!-- v-model does 2 things -->
          <!-- 1. add value attribute -->
          <!-- 2. add @input event -->
          <app-switch v-model="dataSwitch"></app-switch>
          <!-- Custom control: default have value prop and @input event -->
        </div>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          <button class="btn btn-primary" @click.prevent="submiited">Submit!</button>
        </div>
      </div>
    </form>
    <hr />
